...
public static void main(String args[]) {
    try (Scanner sc = new Scanner(System.in)) {
        ...
        // ReverseLL
        System.out.print("\nWant to check weather a LinkedList contains loop/cycle or not? (y/n): ");
        ch = sc.next().charAt(0);
        if (ch == 'y') {
            if(ll.isCycle()){
                System.out.println("LinkedList contain loop/cycle");
            }
            else{
                System.out.println("LinkedList do not contain loop/cycle");
            }
        }
